...
for Version 12.1.0 of the Unicode Standard.
...
pdf code charts corresponding exactly to Version 12.1.0.

The "ucdxml" subdirectory contains the XML version of
the Unicode Character Database.

Zipped versions of UCD data files for Version 12.1.0 are
posted in:

http://www.unicode.org/Public/zipped/12.1.0/
